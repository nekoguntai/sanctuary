      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            type="number"
            value={singletonPort}
            onChange={(e) => updateNetworkConfig('singletonPort', parseInt(e.target.value, 10) || 50002)}
            className="w-full px-3 py-2 surface-muted border border-sanctuary-200 dark:border-sanctuary-700 rounded-lg text-sm"
          />
        </div>
      </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                type="number"
                value={poolMin}
                onChange={(e) => updateNetworkConfig('poolMin', parseInt(e.target.value, 10) || 1)}
                min={1}
                max={poolMax}
                className="w-full px-3 py-2 surface-muted border border-sanctuary-200 dark:border-sanctuary-700 rounded-lg text-sm"
              />
            ...
            <div>
              ...
              <input
                type="number"
                value={poolMax}
                onChange={(e) => updateNetworkConfig('poolMax', parseInt(e.target.value, 10) || 5)}
                min={poolMin}
                max={20}
                className="w-full px-3 py-2 surface-muted border border-sanctuary-200 dark:border-sanctuary-700 rounded-lg text-sm"
              />
              ...
              <div className="flex space-x-2">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    onChange={(e) => setNewServer({ ...newServer, port: parseInt(e.target.value, 10) || 50002 })}
                    className="w-full px-3 py-2 surface-muted border border-sanctuary-200 dark:border-sanctuary-700 rounded-lg text-sm"
                  />
                </div>
                <div>
