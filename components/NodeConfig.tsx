  ...
  const handleTorContainerToggle = async () => {
    ...
    try {
      if (torContainerStatus.running) {
        ...
        // Start (or create and start) the container
    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      {nodeConfig && (
        <div className="space-y-6">
          ...
          {/* Section 5: Proxy / Tor Settings - Electrum Only */}
          {nodeConfig.type === 'electrum' && (
            <div className="surface-elevated rounded-2xl border border-sanctuary-200 dark:border-sanctuary-800 overflow-hidden">
              <div className="p-4 border-b border-sanctuary-100 dark:border-sanctuary-800 bg-sanctuary-50/50 dark:bg-sanctuary-800/30">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-sanctuary-500">Route Electrum connections through SOCKS5 proxy for privacy</p>
                    </div>
                  </div>
                  <button
