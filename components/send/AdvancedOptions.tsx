...
export interface AdvancedOptionsProps {
  ...
  // Skip rendering the header/toggle button (for when parent handles expand/collapse)
  hideHeader?: boolean;
}
...
export function AdvancedOptions({
  ...
  // If hideHeader is true, skip rendering the toggle button
  // This allows parent components to handle their own expand/collapse UI
  const isExternallyControlled = hideHeader;

  if (isExternallyControlled) {
    // Just render the options content without wrapper
    return (
