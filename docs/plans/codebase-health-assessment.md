...
- Sweep for any admin surfaces outside the modular admin router and continue documenting any remaining non-wallet public domains beyond the completed price, Bitcoin utility/node, sync-management, transaction-helper, device secondary, label-association, auth-secondary, health, and global approval-helper coverage.
