...
// ========================================
// AGGREGATED TRANSACTION ENDPOINTS
// These must come BEFORE parameterized routes like /transactions/:txid
// to avoid Express treating 'recent', 'pending', etc. as txid parameters
// ========================================
...
// ========================================
// PARAMETERIZED TRANSACTION ENDPOINTS
// These come AFTER specific path routes to avoid matching issues
// ========================================
